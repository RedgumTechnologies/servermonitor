...
$ServerMonitorUrl = "http://status.servermonitor.local/api/v1/"
...
$regInfo.Description = 'System Status Reporting'
...
$Rootfolder.RegisterTaskDefinition('System Status Reporting', $TaskDefinition, 6, "System", $null , 5)
...
$Rootfolder.RegisterTaskDefinition('System Status Auto-Update', $TaskDefinition, 6, "System", $null , 5)
