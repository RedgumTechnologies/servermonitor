...
namespace ServerMonitor.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //bundles.Add(new ScriptBundle("~/bundles/crossBrowserPopup").Include(
            //            "~/Scripts/crossBrowserPopup.js"));
            ...
            //bundles.Add(new StyleBundle("~/Content/categories/css").Include("~/Content/categories.css"));
        }
    }
}